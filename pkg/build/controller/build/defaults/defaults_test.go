...
func TestLabelDefaults(t *testing.T) {
	...
	for i, test := range tests {
		...
		for _, l := range test.defaultLabels {
			...
			legacyscheme.Scheme.Convert(l, &internalLabel, nil)
...
func TestResourceDefaults(t *testing.T) {
	...
	for name, test := range tests {
		internalResources := internalcore.ResourceRequirements{}
		legacyscheme.Scheme.Convert(test.DefaultResource, internalResources, nil)
		defaults := BuildDefaults{Config: &configapi.BuildDefaultsConfig{Resources: internalResources}}
